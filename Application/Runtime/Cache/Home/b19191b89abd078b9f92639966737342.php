...
<div id="login_logo">
<?php if(isset($_COOKIE['user'])): ?><a href="/index.php/Home/Myhome/index" class="right_pic"><img id="user_photo" title="<?php echo (session('user')); ?>" src="/Public/IMAGES/<?php echo (session('photo')); ?>" /></a>
<span></span>
<a href="/index.php/Home/login/quit" class="right_pic" title="退出" >退出</a>
<?php else: ?>
<a href="/index.php/Home/liu/xiaofa" class="right_pic" id="login_button">登陆</a>
...
<table height="300">
<form id='login_form' action="/index.php/Home/liu/xiaofa" method="post">
...
<tr><td colspan="2"><a href="/index.php/Home/liu/fabao"><img src="/Public/IMAGES/vMxJ92yhfge0Qejup0.jpg" class="imgs" width="100%" height="250px" /><span style="position:absolute;top:250px;right:15%;font-size:40px;color:#FFF;">游戏商城讨论区</span></a></td></tr>
<tr>
<td colspan="2"><am style="color:#0F3;">>>>>>>>>>>>>>>>>>>>>>>>></am><am style="color:#66F;"><<<<<<<<<<<<<<<<<<<<<<<<<<</am></td>
</tr>
<?php if(is_array($data)): foreach($data as $key=>$value): ?><tr>
<td id="tuan" colspan="2"><span id="name" ><a href="/index.php/Home/Liu/xiaofaindex/id/<?php echo ($value["id"]); ?>/content/<?php echo ($value["content"]); ?>">[标题]：<?php echo ($value["content"]); ?></a></span><span id="user">作者：<?php echo ($value["name"]); ?></span><span class="sj">发表时间：<?php echo ($value["sj"]); ?></span><span class="sj1"><a href="/index.php/Home/Liu/xiaofaindex/id/<?php echo ($value["id"]); ?>/content/<?php echo ($value["content"]); ?>" class="comment_a">查看评论</a>（<b style="color:#F0F;"><?php echo ($value["diaoji"]); ?></b>帖子）</span></td>
</tr><?php endforeach; endif; ?>
<tr><td colspan="2"  id="last_line"><?php echo ($msg); ?></td></tr>
</table> 

<div id="fa">
<form action="/index.php/Home/Liu/radd" method="post" enctype="multipart/form-data">
