...
<tr><td>1</td><td><?php echo ($result["name"]); ?></td><td><span class="pay_money"><?php echo ($result["price"]); ?></span></td><td><img src="/Public/IMAGES/<?php echo ($result["path"]); ?>" /></td></tr>
...
<tr><td></td><td></td><td></td><td style="text-align:left">总价共:<span class="pay_money"><?php echo ($result["price"]); ?></span>点卷 实付:<span class="pay_money"><?php echo ($result['price']/100); ?></span>元</td></tr>
...
<input type="hidden" name="je" value="<?php echo ($result['price']/100); ?>" />
</form>
</div>
