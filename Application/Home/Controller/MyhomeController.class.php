...
class MyhomeController extends Controller
{
	...
	public function order()                                            //用户订单
	{
		...
		$result=$m->limit($page->limit)->where($data)->alias(a)->field('a.phone,b.orderid,b.commodityname,b.price,b.addtime,c.xingming,c.shengfen,c.city,c.street')->join("__ORDERLIST__ b ON b.userid=a.id")->join("__USERADDR__ C ON c.userid=a.id")->order('op desc')->select();
		$this->assign('result',$result);
