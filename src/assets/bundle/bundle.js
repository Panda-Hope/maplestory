...
/***/ function(module, exports, __webpack_require__) {
	...
	var _effects = __webpack_require__(163);
	...
	_vue2.default.http.options.emulateJSON = true; //for support form submit in php
	...
	router.beforeEach(function (transition) {
	   // login check
	   transition.to.requireAuth && !_userLogin.Users.isLogin() && transition.redirect({ path: '/' });
	   transition.next();
	});
	    ...
	    router.map({
	        '/': {
	            component: function component(resolve) {
	                __webpack_require__.e/* require */(6, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(6)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	            },
	            requireAuth: false
	        },
	        '/register': {
	            component: function component(resolve) {
	                __webpack_require__.e/* require */(7, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(55)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	            },
	            requireAuth: false
	        },
	        '/search/:searchKey': {
	            component: function component(resolve) {
	                __webpack_require__.e/* require */(8, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(63)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	            },
	            requireAuth: false
	        },
	        '/pay': {
	            component: function component() {
	                __webpack_require__.e/* require */(9, function() {[__webpack_require__(167)];});
	            },
	            requireAuth: true
	        },
	        '/user': {
	            component: function component(resolve) {
	                __webpack_require__.e/* require */(11, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(65)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	            },
	            requireAuth: true
	        },
	        // 404 route
	        '*': {
	            component: function component(resolve) {
	                __webpack_require__.e/* require */(10, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(161)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	            },
	            requireAuth: false
	        }
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Notice = exports.Users = undefined;

	var _notice = __webpack_require__(31);
	...
	Users.prototype.login = function (_relatedTarget, _relatedContext) {
		...
		if ($formElem.length == 1) {
			(function () {
				var data = _this.serializeObject($formElem.serializeArray()),
				    _self = _this;

				_this.vue.$http.post('../index.php/Home/Login/check', data).then(function (response) {
					if (response.data) {
						...
						_notice2.default.showNotice(_data);
					}
				});
			})();
		} else {
	...
	Users.prototype.recordMsg = function () {
		...
		if (!cookies.user) {
			...
			_notice2.default.showNotice(data);
			return false;
		}
