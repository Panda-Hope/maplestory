...
<form id='login_form' action="/index.php/Home/Pay/search" method="post">
...
<!--商品部分-->
<div class="commodity">
<p id="com_title">搜索结果</p>
<?php if(!empty($result)): if(is_array($result)): foreach($result as $key=>$vo): ?><div class="com_pic">
...
<a href="/index.php/Home/Pay/shoppingsearch/carname/<?php echo ($vo["name"]); ?>" class="button_carxxx"><img src="/Public/IMAGES/cart.png" /></a>
