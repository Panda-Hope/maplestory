...
<a href="/index.php/Home/Pay/shoppingcar/carname/<?php echo ($vo["name"]); ?>" class="button_carxxx"><img src="/Public/IMAGES/cart.png" /></a>           <!--购物车图标-->
